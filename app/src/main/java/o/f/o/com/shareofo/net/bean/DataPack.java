...
public final class DataPack extends Message<DataPack, DataPack.Builder> {
  ...
  public DataPack(Integer current, Integer total, List<OfoDate> data) {
    this(current, total, data, ByteString.EMPTY);
  }

  public DataPack(Integer current, Integer total, List<OfoDate> data, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<DataPack, Builder> {
    ...
    public DataPack build() {
      return new DataPack(current, total, data, super.buildUnknownFields());
    }
  }
  ...
  private static final class ProtoAdapter_DataPack extends ProtoAdapter<DataPack> {
    ...
    public int encodedSize(DataPack value) {
      return (value.current != null ? ProtoAdapter.INT32.encodedSizeWithTag(1, value.current) : 0)
          + (value.total != null ? ProtoAdapter.INT32.encodedSizeWithTag(2, value.total) : 0)
          + OfoDate.ADAPTER.asRepeated().encodedSizeWithTag(3, value.data)
    ...
    public void encode(ProtoWriter writer, DataPack value) throws IOException {
      ...
      if (value.total != null) ProtoAdapter.INT32.encodeWithTag(writer, 2, value.total);
      OfoDate.ADAPTER.asRepeated().encodeWithTag(writer, 3, value.data);
    ...
    public DataPack decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 2: builder.total(ProtoAdapter.INT32.decode(reader)); break;
          case 3: builder.data.add(OfoDate.ADAPTER.decode(reader)); break;
          default: {
